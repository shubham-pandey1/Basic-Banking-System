...
<head>
    ...
    <title>Transactions - Federal Bank</title>
</head>
...
echo "<tbody>";
        ...
        while($row = mysqli_fetch_assoc($result))
        {
          echo '<tr>';
           ...
           echo '<td>'; ?><?php if($row['Status'] == 'succeed'){echo '<b><p style= "color:green;">Success</p></b>';}else{echo '<b><p style= "color:red;">Failed</p></b>';} ?> <?php echo '</td>';
          echo '</tr>';
            }
        }
    echo "</tbody> </table";
