...
<head>
    ...
    <title>Send money - Federal Bank</title>
                    ...
                    <table>
                        <tr>
                            <td><input type="text" class="formin form-control" name="accno1" id=""
                                    ...
                                    value="<?php if(isset($_GET['reads'])){echo $_GET['reads'];} ?>" required></td>
                        <tr>
                        <tr>
                            <td><input type="number" class="formin form-control" name="amount" id=""
                                    placeholder="Amount to Transfer" required></td>
                        </tr>
                        <tr>
                            <td><input type="text" class="formin form-control" name="accno2" id=""
                                    placeholder="Reciever's Account Number" required></td>
                        </tr>
                    </table>
